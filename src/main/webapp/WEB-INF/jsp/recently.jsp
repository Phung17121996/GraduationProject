...
<section class="cart bgwhite p-t-70 p-b-100">
    ...
    <div class="container">
        <h1 style="margin-left: 15em;font-size: xx-large;font-style: initial; margin-bottom: 1em"><strong>MY RECENTLY</strong></h1>
        <table class="display" id="dataTable">
            ...
            <tbody>
            <c:forEach var="recently" items="${recentlyList}">
                <tr class="item-row" id="item-row">
                    <td> <img style="height: 50px;width: 50px" src="/resources/images/product/${recently.productEntity.imageEntities[0].imageName}"/></td>
                    <td>
                        <p><a href="product-detail?productId=${recently.productEntity.id}&categoryId=${recently.productEntity.categoryEntity.id}">
                                ${recently.productEntity.productName}
                        </a></p>
                    </td>
                    <td  title="Category">
                        <a href="product?categoryId=${recently.productEntity.categoryEntity.id}">
                                ${recently.productEntity.categoryEntity.categoryName}
                        </a>
                    </td>
                    <td>
                        <c:if test="${recently.productEntity.productQuantityEntity.quantity == 0}">
                    ...
                    <td  title="View">${recently.productEntity.viewEntity.count}</td>
                    <td  title="Price" style="color: red;"><strong>$ ${recently.productEntity.price}</strong></td>
                    <td>
                        <a href="deleteRecently?recentlyId=${recently.id}&userId=${recently.userEntity.id}">
