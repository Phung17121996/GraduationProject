...
/**
 * Created by PhunHV on 31/10/2018.
 */
@Configuration
...
public class SpringConfig {
    ...
    DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/graduation"); //spring-jpa-1: database name
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        entityManager.setPackagesToScan("graduation.entity");
