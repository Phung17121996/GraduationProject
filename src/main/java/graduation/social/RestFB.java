...
@Component
public class RestFB {
    public static String FACEBOOK_APP_ID = "705084929853943";
    public static String FACEBOOK_APP_SECRET = "d9725ce3767144484c8d91fe960d367d";
    public static String FACEBOOK_REDIRECT_URL = "https://localhost:8081/login-facebook";
